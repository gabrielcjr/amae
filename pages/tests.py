...
class TestSiteImagesContextProcessor:
    def test_returns_dict_keyed_by_slug(self):
        SiteImage.objects.create(key='hero', description='Hero', external_url='https://x.com/1.jpg')
        SiteImage.objects.create(key='logo', description='Logo', external_url='https://x.com/2.jpg')
